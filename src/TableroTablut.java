...
public class TableroTablut extends JFrame{
	...
	final int[] posBlancasX = {2,3,4,4,4,4,5,6}, 
			posBlancasY = {4,4,2,3,5,6,4,4},
			posNegrasX = {0,0,0,1,3,3,4,4,4,4,5,5,7,8,8,8},
			posNegrasY = {3,4,5,4,0,8,0,1,7,8,0,8,4,3,4,5};
	final int LIMITE = 9,CENTRO;
	...
	public TableroTablut(ManejadorTablero mT, ManejadorRey mR,ManejadorFichas mF){
		super("Tablut");
		setLayout(null);
		setSize(800,560);
		setResizable(false);
